...
const HeaderLogin = () => {
  ...
  return (
          ...
          {user ? (
            <div className="flex items-center">
              ...
              <img
                ...
                alt="User avatar"
              />
              <button className="mr-4 flex items-center border border-[#8e9aaf] rounded-sm px-1 py-1" onClick={() => setIsOpen(true)}>
    ...
    //           className="h-[60px] w-auto"
    //         />
    //         <h1 className="text-[#000000] text-lg font-bold pb-3">CasacaTec</h1>
    //       </div>
    //     </NavLink>
