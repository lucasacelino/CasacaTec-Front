...
import AtividadeIcon from "./assets/icons/AtividadeIcon";
import DistribuicaoIcon from "./assets/icons/DistribuicaoIcon";
import UsinaIcon from "./assets/icons/UsinaIcon";
import CadastrarIcon from "./assets/icons/CadastrarIcon"
import SementeIcon from "./assets/icons/SementeIcon";
import TecnicoIcon from "./assets/icons/TecnicoIcon";
import AcompanharIcon from "./assets/icons/AcompanharIcon";
import ProdutorIcon from "./assets/icons/ProdutorIcon"
...
const menuItems = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        id: "colheitas-entregue",
        title: "Colheitas Entregue",
        path: "/usina/colheitas-entregue",
        icon: <AtividadeIcon className="w-4 h-4 mr-2" />,
      },
    ],
  },
    ...
    <li key={item.id}>
      <button
        ...
        className={`flex items-center text-left whitespace-normal p-2 pl-3 rounded-lg text-sm transition-colors duration-200 hover:bg-[#f76300] bg-opacity-80 ${
          activeItem === item.id
            ? "text-[#FFFFFF] font-medium bg-[#f76300]"
